...
class BoundingBoxController(object):
    ...
    # update image (LXH)
    # @has_active_bbox_decorator
    # def update_image_projection(self):        
        # out_dict = {}
        # out_dict['name'] = 'current_frame'
        # out_dict['timestamp'] = 0
        # out_dict['index'] = 0
        # labels_list = []
                
        # for i in range(len(self.bboxes)):
        #     if i!= self.active_bbox_id:
        #         continue
        #     bbox = self.bboxes[i]
            
        #     label_i = {}
        #     label_i['id'] = i+1
        #     label_i['category'] = bbox.classname               
        ...
        #     orientation = {'x_rotation':float(0.0),'y_rotation':float(0.0),'z_rotation':float(bbox.z_rotation/180.0*np.pi)}
        ...
        # file_pred = self.view.current_bbox_folder+'/current.yaml'
        # with open(file_pred, 'w') as f:
        #     yaml.safe_dump(out_dict, f)
        # f.close()        
        
        # # update indicator
        # file_indocator = self.view.current_bbox_folder+'/indicator.txt'
        # if os.path.exists(file_indocator):
        #     index = np.loadtxt(file_indocator)
        #     index += 0.1
        # else:
        #     index = 0.0
        # with open(file_indocator, 'w') as f:
        #     f.write(str(index))        
        # f.close()
        ...
        # for i in range(len(self.view.imageLabelList)):
        #     P = self.view.imagePMatrixList[i]
        ...
        #     pixelmap = QPixmap.fromImage(self.view.imageDataList[i])
        ...
        #     painter.end()
        #     self.view.imageLabelList[i].setPixmap(pixelmap)
        #     self.view.imageLabelList[i].update()
